  ...
  <div class="lg:h-screen lg:h-[100dvh] py-5 grid place-items-center">
    <div class="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg">
      ...
      <h3 class="text-xl my-3">
        Subir foto actualizada de autorizado
      </h3>
      <span class="text-sm mb-3">*evitar lentes, sombreros y mala iluminación</span>
      <label
        for="file-upload"
      ...
      >
        <div class="flex items-center bg-gray-100">
          ...
          <div class="text-center mx-3 px-3 py-5">
            <p class="text-lg px-3 mt-3">Arrastra y suelta tus archivos aquí</p>
